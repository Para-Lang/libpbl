...
__attribute__((unused)) PblLong_T *PblGetLongT(signed long val){PBL_CONVERSION_FUNCTION_DEF_CONSTRUCTOR(PblLong_T, signed long)}

__attribute__((unused)) PblULong_T *PblGetULongT(unsigned long val){PBL_CONVERSION_FUNCTION_DEF_CONSTRUCTOR(PblULong_T, unsigned long)}
...
__attribute__((unused)) PblFloat_T *PblGetFloatT(float val){PBL_CONVERSION_FUNCTION_DEF_CONSTRUCTOR(PblFloat_T, float)}

__attribute__((unused)) PblDouble_T *PblGetDoubleT(double val){PBL_CONVERSION_FUNCTION_DEF_CONSTRUCTOR(PblDouble_T, double)}
