...
PBL_INIT_GLOBALS {
  ...
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblChar_T, "char", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblUChar_T, "uchar", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblShort_T, "int", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblUShort_T, "ushort", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblInt_T, "int", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblUInt_T, "uint", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblLong_T, "long", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblULong_T, "ulong", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblLongLong_T, "longlong", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblULongLong_T, "ulonglong", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblFloat_T, "float", false, true);
  PBL_REGISTER_TYPE(&LOCAL_TYPE_LIST, PblDouble_T, "double", false, true);
};
...
__attribute__((unused)) PblPointer_T *PblGetPointerT(void *val, PblType_T *type) {
  struct PblPointer_Base struct_type = {.p_void = val, .p_type = type};
  PBL_CONVERSION_FUNCTION_DEF_CONSTRUCTOR(PblPointer_T, struct_type, struct PblPointer_Base);
}

PblBool_T *PblGetBoolT(bool val) { PBL_CONVERSION_FUNCTION_DEF_CONSTRUCTOR(PblBool_T, val, bool); }
