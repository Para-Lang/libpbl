...
TEST(MacroTypesTest, PblSizeof) { EXPECT_EQ(PblBool_T_Size, PBL_SIZEOF_ON_COMPILETIME(PblBool_T)); }

TEST(MacroTypesTest, CSizeof) { EXPECT_EQ(sizeof(char), PBL_C_SIZEOF(char)); }
